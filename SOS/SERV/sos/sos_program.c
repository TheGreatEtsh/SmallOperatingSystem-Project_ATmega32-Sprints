...
{//Line23
	...
	else if(TIMER_enableInterrupt(TIMER_0)==TIMER_OK)
	{
		//sos status sucess
	...
	else if(TIMER_setCallBack(TIMER_0, sos_sys_tick_task)==TIMER_OK)
	{
		//sos status sucess
	}
...
{//Line138
	...
	else if(TIMER_disableInterrupt(TIMER_0)==TIMER_OK)
	{
	...
	else if(TIMER_pause(TIMER_0)==TIMER_OK)
	{
		enu_sos_status_retval = SOS_STATUS_SUCCESS;
	}
